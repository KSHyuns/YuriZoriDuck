namespace GooglePlayGames.BasicApi
{
    public enum SignInInteractivity
    {
        ...
        /// 2. If silent sign in fails, check if user has previously declined to sign in and don?? prompt interactive
        ...
        /// remember this for step 2 the next time the user opens the game and don?? ask for sign-in.
        /// </summary>
        CanPromptOnce
    }
}
